...
namespace HistoriasClinicas.Controllers
{
    public class NotasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Mensaje,FechaYHora")] Nota nota)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Mensaje,FechaYHora")] Nota nota)
        {
            if (id != nota.Id)
            {
                return NotFound();
