...
namespace HistoriasClinicas.Controllers
{
    public class DiagnosticosController : Controller
    {
        ...
        {
            ViewData["IdEpicrisis"] = new SelectList(_context.Epicrisis, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Descripcion,Recomendacion,IdEpicrisis")] Diagnostico diagnostico)
        {
            ...
            ViewData["IdEpicrisis"] = new SelectList(_context.Epicrisis, "Id", "Id", diagnostico.IdEpicrisis);
            return View(diagnostico);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descripcion,Recomendacion,IdEpicrisis")] Diagnostico diagnostico)
        {
