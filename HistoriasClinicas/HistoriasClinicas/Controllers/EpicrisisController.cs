...
namespace HistoriasClinicas.Controllers
{
    public class EpicrisisController : Controller
    {
        ...
        {
            ViewData["IdEpisodio"] = new SelectList(_context.Episodios, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FechaYHora,IdEpisodio")] Epicrisis epicrisis)
        {
            ...
            ViewData["IdEpisodio"] = new SelectList(_context.Episodios, "Id", "Id", epicrisis.IdEpisodio);
            return View(epicrisis);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FechaYHora,IdEpisodio")] Epicrisis epicrisis)
        {
            if (id != epicrisis.Id)
            {
                return NotFound();
